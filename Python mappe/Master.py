...
"""
Intro_tekst_alternativ_1_resultat = """Gjennom samtalene får Erling et godt syn på saken fra begge sider.
Ved å gjøre dette kommer han på, med litt hjelp fra dem på siden til Silje, en plan til å gjøre Silje sitt forslag mer realistisk.
Etter Erling presenterer dette for Sivert er han overbevist og går med på ideen.
"""
...
"""
Hamdi_og_Jabir_tekst_alternativ_2_resultat = """Hamdi og Jabir forblir uenige med hverandre og konflikten utvikler seg i de kommende ukene. 
Når prosjektet nærmer seg deadlinen for første prototype er de fremdeles ikke enige om en løsning, og Erling begynner å føle tidspresset. 
"""
...
"""
Møte_tekst_Hamdi_og_Jabir_alternativ_1_resultat = """Erling velger Jabir sin løsning og tror den kan implementeres, 
selv om første prototypen kanskje må fuske litt med presentasjonen av den for å bli ferdig i tide.
"""
...
Han vet at det er kort tid igjen, men det er kanskje mulig å få til noe om han setter opp et møte i siste liten. Han må ta et viktig valg.
"""
Vente_tekst_Hamdi_og_Jabir_alternativ_1 = """Han setter opp et møte for å ha teamet bestemme en teknologisk løsning.
"""
Vente_tekst_Hamdi_og_Jabir_alternativ_1_resultat = """Teamet kommer frem til at det ikke er tid for Jabir sin løsning og går for
Hamdi sin for å prøve å få noe til med resten av tiden de har.
"""
Vente_tekst_Hamdi_og_Jabir_alternativ_2 = """Han håper at Hamdi og Jabir kan bli enige om en løsning.
"""
Vente_tekst_Hamdi_og_Jabir_alternativ_2_resultat = """Hamdi og Jabir fortsetter å være uenige, og konflikten er nå en personkonflikt. 
Det er ikke kommet frem til en løsning før deadlinen til første prototype.
"""
...
hvor de kan snakke om sine løsninger seg i mellom og deretter gjøre en felles innsats for å få best mulig resultater. 
...
#Mengden poeng leder til hvilken av de 3 sluttene en får. Mulige poeng: + 1 eller - 1 
Poeng = 0

#Start på program
def Start_Silje_og_Sivert():
    global Poeng
    print(Intro_tekst)
    print("1: " + Intro_tekst_alternativ_1)
    print("2: " + Intro_tekst_alternativ_2)
    
    while True:
        input1 = input("Skriv 1 eller 2: ")
        
        if input1 == str(1):
            print(Intro_tekst_alternativ_1_resultat)
            Poeng += 1
            Hamdi_og_Jabir()
            break

        elif input1 == str(2):
            print(Intro_tekst_alternativ_2_resultat)
            Poeng -= 2
            Hamdi_og_Jabir()
            break
...
def Hamdi_og_Jabir():
    global Poeng
    print(Hamdi_og_Jabir_tekst)
    print("1: " + Hamdi_og_Jabir_tekst_alternativ_1)
    print("2: " + Hamdi_og_Jabir_tekst_alternativ_2)

    while True:
        input2A = input("Skriv 1 eller 2: ")

        if input2A == str(1):
            print(Hamdi_og_Jabir_tekst_alternativ_1_resultat)
            Poeng += 1
            Møte_Hamdi_og_Jabir()
            break

        elif input2A == str(2):
            print(Hamdi_og_Jabir_tekst_alternativ_2_resultat)
            Poeng -= 1
            Tidspress_Hamdi_Jabir()
            break

        else:
            print("Input not recognized, try again.")

def Møte_Hamdi_og_Jabir():
    global Poeng
    print(Møte_tekst_Hamdi_og_Jabir)
    print("1: " + Møte_tekst_Hamdi_og_Jabir_alternativ_1)
    print("2: " + Møte_tekst_Hamdi_og_Jabir_alternativ_2)

    while True:
        input3A = input("Skriv 1 eller 2: ")

        if input3A == str(1):
            print(Møte_tekst_Hamdi_og_Jabir_alternativ_1_resultat)
            Poeng += 1
            Poeng_sjekk()
            break
            
        elif input3A == str(2):
            print(Møte_tekst_Hamdi_og_Jabir_alternativ_2_resultat)
            Poeng -= 1
            Poeng_sjekk()
            break
...
def Tidspress_Hamdi_Jabir():
    global Poeng
    print(Vente_tekst_Hamdi_og_Jabir)
    print("1: " + Vente_tekst_Hamdi_og_Jabir_alternativ_1)
    print("2: " + Vente_tekst_Hamdi_og_Jabir_alternativ_2)

    while True:
        input3A = input("Skriv 1 eller 2: ")

        if input3A == str(1):
            print(Vente_tekst_Hamdi_og_Jabir_alternativ_1_resultat)
            Poeng += 1
            Poeng_sjekk()
            break

        elif input3A == str(2):
            print(Vente_tekst_Hamdi_og_Jabir_alternativ_2_resultat)
            Poeng -= 1
            Poeng_sjekk()
            break
...
Start_Silje_og_Sivert()

print("Dine poeng: " + str(Poeng))